...
export const WhatIsAsylum = () => {
	return (

		<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
			<div className="group p-4 bg-white dark:bg-gray-800 rounded-lg transition-colors">

			<div>
				Seeking asylum means you are asking for a country’s protection because you are in danger
			...
			<div className="mt-4">
				See "Usefull addresses" section to find social and legal help from a
				specialised organisation.
				For more information about the different steps
				of the procedure, see page 44.
			</div>
			</div>
		</div>
	);
