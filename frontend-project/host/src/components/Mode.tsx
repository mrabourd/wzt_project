...
export default function Mode ({ darkMode, setDarkMode }: { darkMode: boolean, setDarkMode: (val: boolean) => void }) {
  return (
      <button
        ...
        className="fixed float-right top-4 right-6 z-50 flex items-center gap-2 px-3 py-2 rounded-full 
      ...
      >
        ...
        {/* <div className="px-2 sm:px-6 lg:px-8"> */}
          <span className="hidden sm:inline text-xs font-medium text-gray-600 dark:text-gray-300 uppercase tracking-wider">
            {darkMode ? 'Light' : 'Dark'}
          </span>
        {/* </div> */}
      </button>
