...
export const ResourceList = ({ category }: { category: string }) => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {resources.map((res) => (
        <div key={res.id} className="p-4 bg-white dark:bg-gray-700 rounded-lg shadow border border-gray-200 transition-colors hover:bg-guide-blue-light">
          <h3 className="font-bold text-lg text-guide-blue dark:text-guide-blue-light">{res.title}</h3>
